...
\begin{center}
\leavevmode
\includegraphics[width=134pt]{lift__vec_8h__dep__incl}
\end{center}
\end{figure}
\subsection*{Macros}
...
\#define \hyperlink{lift__vec_8h_a998bcb2d615941961ec73da0630a5479}{lift\-\_\-vec\-\_\-find\-\_\-if}(var, predicate, rslt)
\begin{DoxyCompactList}\small\item\em A helper macro to search for the element position in the vector {\ttfamily var} that satisfies the {\ttfamily predicate}. \end{DoxyCompactList}\item 
\#define {\bfseries lift\-\_\-vec\-\_\-bsearch}(var, val, rslt, aux)
\item 
...
\item[Examples\-: ]\par
\hyperlink{lift_vec_example_8c-example}{lift\-\_\-vec\-\_\-example.\-c}.\end{Desc}
\hypertarget{lift__vec_8h_a406fc13f110c4eeebbc75ed26437b9f7}{\index{lift\-\_\-vec.\-h@{lift\-\_\-vec.\-h}!lift\-\_\-vec\-\_\-bsearch@{lift\-\_\-vec\-\_\-bsearch}}
\index{lift\-\_\-vec\-\_\-bsearch@{lift\-\_\-vec\-\_\-bsearch}!lift_vec.h@{lift\-\_\-vec.\-h}}
\subsubsection[{lift\-\_\-vec\-\_\-bsearch}]{\setlength{\rightskip}{0pt plus 5cm}\#define lift\-\_\-vec\-\_\-bsearch(
\begin{DoxyParamCaption}
\item[{}]{var, }
\item[{}]{val, }
\item[{}]{rslt, }
\item[{}]{aux}
\end{DoxyParamCaption}
)}}\label{lift__vec_8h_a406fc13f110c4eeebbc75ed26437b9f7}
{\bfseries Value\-:}
\begin{DoxyCode}
\textcolor{keywordflow}{for} (rslt = \hyperlink{lift__vec_8h_a09e49321f68f213ed563b36026507904}{lift\_vec\_begin}(var), aux = \hyperlink{lift__vec_8h_a3e99cd489d53306dc19917e5ad400ba8}{lift\_vec\_end}(var); rslt < aux; ) \{ \(\backslash\)
        void *probe\_ =  rslt + (aux - rslt) / 2;                        \(\backslash\)
        if (val == *(rslt + (aux - rslt) / 2)) \{                        \(\backslash\)
            rslt = probe\_;                                              \(\backslash\)
            break;                                                      \(\backslash\)
        \}                                                               \(\backslash\)
        else \textcolor{keywordflow}{if} (val < *(rslt + (aux - rslt) / 2)) \{                    \(\backslash\)
            aux = probe\_;                                               \(\backslash\)
        \}                                                               \(\backslash\)
        else \{                                                          \(\backslash\)
            rslt = (\textcolor{keywordtype}{void}*)((\textcolor{keywordtype}{char}*)probe\_ + \textcolor{keyword}{sizeof} *rslt);               \(\backslash\)
        \}                                                               \(\backslash\)
    \}
\end{DoxyCode}
...
The result will be stored in the iterator/pointer {\ttfamily rslt}, that you must provide. On success, it will give a safe iterator/position at which the given value was found. On failure, it will give the end iterator.

\begin{DoxyNote}{Note}
this will only work if the type of the elements that are stored in the vector is such that its variables can be compared using the {\ttfamily ==} operator
\end{DoxyNote}
\begin{DoxySeeAlso}{See Also}
\hyperlink{lift__vec_8h_a998bcb2d615941961ec73da0630a5479}{lift\-\_\-vec\-\_\-find\-\_\-if} 
\end{DoxySeeAlso}
\begin{Desc}
\item[Examples\-: ]\par
\hyperlink{lift_vec_example_8c-example}{lift\-\_\-vec\-\_\-example.\-c}.\end{Desc}
\hypertarget{lift__vec_8h_a998bcb2d615941961ec73da0630a5479}{\index{lift\-\_\-vec.\-h@{lift\-\_\-vec.\-h}!lift\-\_\-vec\-\_\-find\-\_\-if@{lift\-\_\-vec\-\_\-find\-\_\-if}}
\index{lift\-\_\-vec\-\_\-find\-\_\-if@{lift\-\_\-vec\-\_\-find\-\_\-if}!lift_vec.h@{lift\-\_\-vec.\-h}}
\subsubsection[{lift\-\_\-vec\-\_\-find\-\_\-if}]{\setlength{\rightskip}{0pt plus 5cm}\#define lift\-\_\-vec\-\_\-find\-\_\-if(
\begin{DoxyParamCaption}
\item[{}]{var, }
\item[{}]{predicate, }
\item[{}]{rslt}
\end{DoxyParamCaption}
)}}\label{lift__vec_8h_a998bcb2d615941961ec73da0630a5479}
{\bfseries Value\-:}
\begin{DoxyCode}
\textcolor{keywordflow}{for} (rslt = \hyperlink{lift__vec_8h_a09e49321f68f213ed563b36026507904}{lift\_vec\_begin}(var); rslt != \hyperlink{lift__vec_8h_a3e99cd489d53306dc19917e5ad400ba8}{lift\_vec\_end}(var); ++rslt) \{ \(\backslash\)
...
A helper macro to search for the element position in the vector {\ttfamily var} that satisfies the {\ttfamily predicate}. 

The result will be stored in the iterator/pointer {\ttfamily rslt}, that you must provide. On success, it will give a safe iterator/position at which the given value was found. On failure, it will give the end iterator.

The {\ttfamily predicate} is an expression that can operate on pretty much anything, but is expected to operate on the {\ttfamily rslt}, which will hold the current iterator in the vector. Use like\-: \begin{DoxyVerb}lift_vec_find_if(v, *iter == 55, iter); // vector of integers
lift_vec_find_if(v, iter->a == 55, iter); // vector of some structures
\end{DoxyVerb}


\begin{DoxySeeAlso}{See Also}
\hyperlink{lift__vec_8h_a88b3bd2c4be95af37a75a6576b2ffafe}{lift\-\_\-vec\-\_\-find} 
\end{DoxySeeAlso}
\begin{Desc}
\item[Examples\-: ]\par
\hyperlink{lift_vec_example_8c-example}{lift\-\_\-vec\-\_\-example.\-c}.\end{Desc}
